...
namespace __Project__.Scripts.Computer.Shopping
{
	public class FloorViewer : MonoBehaviour
	{
		...
		private sealed class _003CDelayedGamepadCheck_003Ed__18 : IEnumerator<object>, IEnumerator, IDisposable
		{
			...
			public FloorViewer _003C_003E4__this;
		...
		[SerializeField]
		private FloorSalesItem m_FloorSalesItemPrefab;
		...
		private List<FloorSalesItem> m_FloorSalesItems;
