...
namespace UnityEngine.Timeline
{
	...
	public abstract class TrackAsset : PlayableAsset, ISerializationCallbackReceiver, IPropertyPreview, ICurvesOwner
	{
		...
		[CompilerGenerated]
		private sealed class _003Cget_outputs_003Ed__69 : IEnumerable<PlayableBinding>, IEnumerable, IEnumerator<PlayableBinding>, IEnumerator, IDisposable
		{
			...
			[DebuggerHidden]
			public _003Cget_outputs_003Ed__69(int _003C_003E1__state)
			{
			}
		...
		{
			[IteratorStateMachine(typeof(_003Cget_outputs_003Ed__69))]
			get
			{
				return null;
			}
