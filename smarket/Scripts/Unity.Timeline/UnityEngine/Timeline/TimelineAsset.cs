...
namespace UnityEngine.Timeline
{
	...
	public class TimelineAsset : PlayableAsset, ISerializationCallbackReceiver, ITimelineClipAsset, IPropertyPreview
	{
		...
		public T CreateTrack<T>(TrackAsset parent, string trackName) where T : new()
		{
			return default(T);
		}

		public T CreateTrack<T>(string trackName) where T : new()
		{
			return default(T);
		}

		public T CreateTrack<T>() where T : new()
		{
			return default(T);
		}
