...
namespace System.Configuration
{
	...
	public sealed class SchemeSettingElementCollection : ConfigurationElementCollection
	{
		...
		/// <exception cref="T:System.Configuration.ConfigurationErrorsException">The <paramref name="index" /> parameter is less than zero.-or- The item specified by the parameter is <see langword="null" /> or has been removed.</exception>
